...
- [Footer更新文档](docs/FOOTER_UPDATE.md) - Footer信息增强的详细说明
- [部署指南](docs/DEPLOYMENT.md) - GitHub Pages部署的完整指南
- [开发文档](docs/DEVELOPMENT.md) - 开发环境搭建和开发流程
- [项目重构](docs/PROJECT_REFACTORING.md) - 项目重构的详细记录
